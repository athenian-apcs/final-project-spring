...
public class GameManager {
  ...
  public GameManager() {
    ...
    // if you're worried about visual hitches more than perfect timing, set this to 1. else 5 should
    // be okay
    ...
    // if you were doing some sort of game that needed to keep EXACT time, you would get rid of
    // this.
    ...
    Thread gameLoop =
        new Thread(
            () -> {
              ...
              // else 5 should be okay
              final int MAX_UPDATES_BETWEEN_RENDER = 1;

              // we will need the last update time.
              long lastUpdateTime = System.nanoTime();
              // store the time we started this will be used for updating map and character
              // animations
              ...
              while (true) {
                ...
                // if for some reason an update takes forever, we don't want to do an insane number
                // of catchups.
                // if you were doing some sort of game that needed to keep EXACT time, you would get
                // rid of this.
                ...
                // Yield until it has been at least the target time between renders. This saves the
                // CPU from hogging.
